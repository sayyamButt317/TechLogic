  ...
  return (
    <div className="relative w-full min-h-[1050px] bg-black overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-16 xl:px-24 2xl:px-32">
        <div className="absolute top-1/3 left-4 md:left-16 lg:left-24 xl:left-32 2xl:left-48 flex flex-col items-start justify-center h-1/2 text-white z-20">
          <motion.div
        ...
        {/* Heading */}
        <div className="absolute top-1/4 text-center ml-4 md:ml-6 text-white z-20">
          <motion.h1
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
